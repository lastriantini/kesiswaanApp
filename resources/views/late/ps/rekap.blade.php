...
<div class="navbar" style="margin-top: 50px; padding-top: -50px;">
    <ul class="nav nav-tabs" style="margin-top: -70px; padding-top: -50px;">
        <li class="nav-item">
          <a class="nav-link" href="{{ route('ps.late.allData') }}">Keseluruhan Data</a>
        </li>
        <li class="nav-item">
    ...
    <table class="table table-bordered mt-3" style="text-align: center;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{ route('ps.late.more', ['id' => $item->student_id]) }}">detail</a></td>
                {{-- untuk mencetak pdf surat --}}
                @if($item->total_late >= 3)
                <td class="d-flex">
                    <a href="{{ route('ps.late.unduhPDF', ['id' => $item->student_id]) }}" style="margin-right: -80px;" class="btn btn-danger">Cetak Surat Pernyataan</a>
                </td>
                @endif
            </tr>
            @endforeach
