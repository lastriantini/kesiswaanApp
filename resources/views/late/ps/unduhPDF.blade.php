...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="data" style="line-height: 20px; margin-bottom: 55px;">
                <p>NIS : {{ $lates['nis'] }}</p>
                <p>Nama: {{ $lates['name'] }}</p>
            ...
            <p style="margin-top: 55px;">Demikian surat pernyataan terlambat ini saya buat dengan penuh penyesalan.</p>
        </div>
        ...
        <div class="top" style="margin-top: 60px;">
            ...
            <div class="top-right">
                <p style="margin-top: -10px;">Bogor, 24 November 2023 </p>
                <p style="margin-bottom: 100px;">Orang Tua/Wali Peserta Didik,</p>
                <p>( ............................. )</p>
            </div>
        </div>

        <div class="bottom" style="margin-top: 60px; margin-bottom: 60px;">
